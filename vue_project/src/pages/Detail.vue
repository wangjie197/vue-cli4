  ...
  <div class="detail">
    ...
    <div class="content" v-if="detail.title">
      <div class="header clear">
		<h2><img width="50px" :src="$baseUrl + detail.detail.icon" alt=""/></h2>
...
export default {
  ...
  components:{
    ...
    activated(){
		...
		// this.$store.dispatch('DETAIL',{apiname,_id})
		// this.$store.dispatch(this.$types.DETAIL,{apiname,_id})
		this[this.$types.DETAIL]({apiname,_id})
	},
    updated(){},
    methods:mapActions('detail',[DETAIL]),
