...
<!--        <UcIuput text='账号' type='text' :value='username' @input='checkUser'/>
 -->
		 <uc-input debal='账号' type='text' v-model='username'/>
        <uc-input debal='密码' type='password' v-model='password'/>
    </div>
    <div class="footbox">
      ...
      <!-- <Button text="注 册"  @click="show"/> -->
      <!-- <Button text="注 册"  bgColor="#399" @click='show'/> -->
<!--      <Button text="注 册"  bgColor="#399" @click.native='show'/>
 -->      <Button text="注 册"  bgColor="#399" @click='reg'/>
